...
public class Controller {
    ...
    public ResponseEntity<Employee> saveEmployeeManual(@RequestBody Employee employee) throws Exception{
        Employee employeeSavedToDB = this.employeeService.manualAddEmployee(employee);
        return new ResponseEntity<Employee>(employeeSavedToDB, HttpStatus.CREATED);
    }
}
